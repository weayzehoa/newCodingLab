...
return [
    ...
    */
    ...
    'drivers' => [
        ...
        //     'site_url' => env('RECAPTCHA_SCRIPT_URL'), // Used for reCAPTCHA v3 'action
        //     'script_url' => env('RECAPTCHA_SCRIPT_URL'),
        ...
        // ],
        'recaptcha' => [
            'site_key' => env('NOCAPTCHA_SITEKEY_V2'),
            'secret_key' => env('NOCAPTCHA_SECRET_V2'),
            'site_url' => env('RECAPTCHA_SCRIPT_URL'), // Used for reCAPTCHA v3 'action
            'script_url' => env('RECAPTCHA_SCRIPT_URL'),
            'verify_url' => env('RECAPTCHA_VERIFY_URL'),
    ...
    */
    ...
    'language' => env('RECAPTCHA_LANG','en'),
