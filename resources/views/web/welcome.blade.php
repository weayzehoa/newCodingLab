                ...
                <div class="col-12">
                    <div class="card card-danger card-outline">
                        <div class="card-body box-profile">
                            <h3 class="profile-username text-center">New CodingLab 程式設計測試站台</h3>
                            ...
                            <i class="fas fa-info text-danger"></i> 此網站 Project 使用 Laravel 10.x && PHP 8.1 版建立，原始碼同步放置於<a href="https://github.com/weayzehoa/newCodingLab" target="_blank">我的GitHub</a>
                        </div>
                    </div>
                </div>
                <div class="col-9">
                                ...
                                <div class="col-6">
                                    <div class="card card-primary card-outline">
                                        <div class="card-body">
                                            ...
                                            <ul>
                                                <li>igoshev/laravel-captcha - 圖形驗證</li>
                                                ...
                                                <li>danielme85/laravel-log-to-db - Log紀錄 套件</li>
