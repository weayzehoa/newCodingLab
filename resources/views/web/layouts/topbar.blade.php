    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="https://codinglab.rvt.idv.tw" class="nav-link" target="_blank">舊版</a></li>
                {{-- <li class="nav-item"><a href="https://{{ env('ADMIN_DOMAIN') }}" class="nav-link" target="_blank">後台管理系統</a></li> --}}
