                                ...
                                <div class="tab-pane active" id="timeline">
                                    ...
                                    <div class="timeline timeline-inverse">
                                        <div class="time-label">
                                            <span class="bg-purple">Dec. 2020 ~ Now</span>
                                            <span class="bg-purple">直流電通股份有限公司</span>
                                        </div>
                                        <div>
                                            <i class="fas fa-code bg-purple"></i>
                                            <div class="timeline-item">
                                                <span class="time"><i class="fas fa-clock"></i> Dec. 2020 ~ Now</span>
                                                ...
                                                <div class="timeline-body">
                                                    <ul>
                                                        <li>公司內部網路建置與維護管理.</li>
                                                        <li><a href="https://{{ env('ICARRY_GATE_DOMAIN') }}" target="_blank">新版中繼管理系統</a></li>
                                                        <ul>
                                                            <li>訂單與鼎新SmartERP串接</li>
                                                            <li>訂單、採購及進出貨管理</li>
                                                        </ul>
                                                        <li><a href="https://{{ env('ICARRY_ADMIN_DOMAIN') }}" target="_blank">新版後台管理系統</a></li>
                                                        <ul>
                                                            <li>商家、商品資料管理</li>
                                                            <li>使用者管理</li>
                                                            <li>行銷策展及活動管理</li>
                                                        ...
                                                        <li><a href="https://{{ env('ICARRY_VENDOR_DOMAIN') }}" target="_blank">新版商家管理系統</a></li>
                                                        <ul>
                                                            <li>商家、商品資料管理</li>
                                                            <li>採購及出貨管理</li>
                                                        </ul>
                                                        <li><a href="https://{{ env('ICARRY_API_DOMAIN') }}" target="_blank">新版前台API建置與維護</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="achievement">
                                    <div class="row">
                                        <div class="post col-md-6">
                                            <div class="card">
                                                <div class="card-header bg-purple">
                                                    <h3 class="card-title"><i class="fas fa-synagogue mr-2"></i><a href="https://{{ env('ICARRY_API_DOMAIN') }}" target="_blank" title="iCarry API 系統" class="text-yellow">iCarry API 系統</a></h3>
                                                </div>
                                                <div class="card-body">
                                                    <a href="{{ asset('img/aboutme/icarry_api.png') }}" data-toggle="lightbox" data-title="iCarry API 系統" data-gallery="gallery">
                                                        <img class="img-fluid" src="{{ asset('img/aboutme/icarry_api.png') }}" alt="icarry_api.png">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post col-md-6">
                                            <div class="card">
                                                <div class="card-header bg-purple">
                                                    <h3 class="card-title"><i class="fas fa-synagogue mr-2"></i><a href="https://{{ env('ICARRY_VENDOR_DOMAIN') }}" target="_blank" title="iCarry 商家後台管理系統" class="text-yellow">iCarry 商家後台管理系統</a></h3>
                                                </div>
                                                <div class="card-body">
                                                    <a href="{{ asset('img/aboutme/icarry_vendor.png') }}" data-toggle="lightbox" data-title="iCarry 商家後台管理系統" data-gallery="gallery">
                                                        <img class="img-fluid" src="{{ asset('img/aboutme/icarry_vendor.png') }}" alt="icarry_vendor.png">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post col-md-6">
                                            <div class="card">
                                                <div class="card-header bg-purple">
                                                    <h3 class="card-title"><i class="fas fa-synagogue mr-2"></i><a href="https://{{ env('ICARRY_ADMIN_DOMAIN') }}" target="_blank" title="iCarry 後台管理系統" class="text-yellow">iCarry 後台管理系統</a></h3>
                                                </div>
                                                <div class="card-body">
                                                    <a href="{{ asset('img/aboutme/icarry_admin.png') }}" data-toggle="lightbox" data-title="iCarry 後台管理系統" data-gallery="gallery">
                                                        <img class="img-fluid" src="{{ asset('img/aboutme/icarry_admin.png') }}" alt="icarry_gate.png">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post col-md-6">
                                            <div class="card">
                                                <div class="card-header bg-purple">
                                                    <h3 class="card-title"><i class="fas fa-synagogue mr-2"></i><a href="https://{{ env('ICARRY_GATE_DOMAIN') }}" target="_blank" title="iCarry 中繼管理系統" class="text-yellow">iCarry 中繼管理系統</a></h3>
                                                </div>
                                                <div class="card-body">
                                                    <a href="{{ asset('img/aboutme/icarry_gate.png') }}" data-toggle="lightbox" data-title="iCarry 中繼管理系統" data-gallery="gallery">
                                                        <img class="img-fluid" src="{{ asset('img/aboutme/icarry_gate.png') }}" alt="icarry_gate.png">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
