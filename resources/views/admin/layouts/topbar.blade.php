<nav id="topbar" class="main-header navbar navbar-expand navbar-dark bg-navy">
    ...
    <ul class="navbar-nav ml-auto">
        {{-- SEARCH FORM --}}
        @if(in_array('M6S1',explode(',',Auth::user()->power)))
        <form action="{{ url('orders') }}" method="GET" class="form-inline mr-2">
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar" type="search" name="keyword" placeholder="輸入關鍵字查找訂單" aria-label="Search" title="輸入訂單號碼、使用者姓名、使用者電話、收件者姓名、收件者電話快速查找訂單">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ url('admins/changePassWord') }}" class="dropdown-item">
                    <i class="fas fa-cog mr-2"></i><span>變更密碼</span>
                </a>
                <div class="dropdown-divider"></div>
